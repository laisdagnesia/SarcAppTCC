  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <ImageBackground style={styles.container} source={require('./../../../assets/images/avaliacaoAntro.png')}>
        ...
        <Button title="Menu" onPress={() => navigation.navigate('menu')} containerStyle={{ borderRadius: 80, width: 320, marginLeft: 30, marginTop: 10 }}  buttonStyle={{ backgroundColor: '#36b6b0',borderRadius: 80}} />
        <Button 
